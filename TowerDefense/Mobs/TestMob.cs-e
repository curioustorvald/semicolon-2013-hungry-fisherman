...
{
    class TestMob : BaseMob
    {
        public TestMob() : base(new ImageSprite( Resources.LPull(NameSet.Mob.FLYING_FISH), 4, 1, 1 ))
        {
            //몹 특성 설정
            setStats("Test mob", NameSet.Mob.TESTMOB, 40, 40, 20, 1, 5, 6, 5);
        }
